...
[Skip to main content](https://platform.kimi.ai/docs/guide/kimi-k2-6-quickstart#content-area)

## [​](https://platform.kimi.ai/docs/guide/kimi-k2-6-quickstart\#overview-of-kimi-k2-6-model)  Overview of Kimi K2.6 Model

Kimi K2.6 is Kimi’s latest and most intelligent model, possessing stronger and more stable long-term code writing capabilities, significantly improved instruction compliance and self-correction capabilities, and the ability to handle more complex software engineering tasks. It also significantly enhances the autonomous execution capabilities of the Agent. It features a native multimodal architecture that supports text, image, and video input, thinking and non-thinking modes, and dialogue and Agent tasks. [Tech Blog](https://www.kimi.com/blog/kimi-k2-6)![kimi-k2.6](https://mintcdn.com/moonshotai/QKwipWA7W5wxQ2Oa/assets/pics/k26.png?fit=max&auto=format&n=QKwipWA7W5wxQ2Oa&q=85&s=f17a118a63d40478a0336ff296a3e0fb)

### [​](https://platform.kimi.ai/docs/guide/kimi-k2-6-quickstart\#long-horizon-coding-capability-breakthrough)  Long-horizon coding capability breakthrough
...
### [​](https://platform.kimi.ai/docs/guide/kimi-k2-6-quickstart\#ultra-long-context-support)  Ultra-Long Context Support
...
### [​](https://platform.kimi.ai/docs/guide/kimi-k2-6-quickstart\#long-thinking-capabilities)  Long-Thinking Capabilities
...
## [​](https://platform.kimi.ai/docs/guide/kimi-k2-6-quickstart\#example-usage)  Example Usage

Here is a complete usage example to help you quickly get started with the Kimi K2.6 model.

### [​](https://platform.kimi.ai/docs/guide/kimi-k2-6-quickstart\#install-the-openai-sdk)  Install the OpenAI SDK
...
### [​](https://platform.kimi.ai/docs/guide/kimi-k2-6-quickstart\#verify-the-installation)  Verify the Installation
...
## [​](https://platform.kimi.ai/docs/guide/kimi-k2-6-quickstart\#quick-start)  Quick Start
...
### [​](https://platform.kimi.ai/docs/guide/kimi-k2-6-quickstart\#image-understanding-code-example)  Image Understanding Code Example
...
### [​](https://platform.kimi.ai/docs/guide/kimi-k2-6-quickstart\#video-understanding-code-example)  Video Understanding Code Example
...
### [​](https://platform.kimi.ai/docs/guide/kimi-k2-6-quickstart\#multimodal-tool-capability-example)  Multimodal Tool Capability Example
...
## [​](https://platform.kimi.ai/docs/guide/kimi-k2-6-quickstart\#best-practices)  Best Practices

### [​](https://platform.kimi.ai/docs/guide/kimi-k2-6-quickstart\#supported-formats)  Supported Formats
...
### [​](https://platform.kimi.ai/docs/guide/kimi-k2-6-quickstart\#token-calculation-and-billing)  Token Calculation and Billing

Image and video token usage is dynamically calculated. You can use the [token estimation API](https://platform.kimi.ai/docs/api/estimate) to check the expected token consumption for a request containing images or video before processing.Generally, the higher the resolution of an image, the more tokens it will consume. For videos, the number of tokens depends on the number of keyframes and their resolution—the more keyframes and the higher their resolution, the greater the token consumption.The Vision model uses the same billing method as the `moonshot-v1` model series, with charges based on the total number of tokens processed. For more information, see:For token pricing details, refer to [Model Pricing](https://platform.kimi.ai/docs/pricing/chat-k26).

### [​](https://platform.kimi.ai/docs/guide/kimi-k2-6-quickstart\#recommended-resolution)  Recommended Resolution
...
### [​](https://platform.kimi.ai/docs/guide/kimi-k2-6-quickstart\#upload-file-or-base64)  Upload File or Base64?

Due to the limitation on the overall size of the request body, for very large videos you **must** use the file upload method to utilize vision capabilities.For images or videos that will be referenced multiple times, it is recommended to use the file upload method. Regarding file upload limitations, please refer to the [File Upload documentation](https://platform.kimi.ai/docs/api/files-upload).Image quantity limit: The Vision model has no limit on the number of images, but ensure that the request body size does not exceed 100MURL-formatted images: Not supported, currently only supports base64-encoded image content

## [​](https://platform.kimi.ai/docs/guide/kimi-k2-6-quickstart\#parameters-differences-in-request-body)  Parameters Differences in Request Body

Parameters are listed in [chat](https://platform.kimi.ai/docs/api/chat). However, behaviour of some parameters may be different in k2.6/k2.5 models.**We recommend using the default values instead of manually configuring these parameters.**Differences are listed below.
...
## [​](https://platform.kimi.ai/docs/guide/kimi-k2-6-quickstart\#tool-use-compatibility)  Tool Use Compatibility
...
You can refer to [Use Thinking Models](https://platform.kimi.ai/docs/guide/use-kimi-k2-thinking-model) for correct usage of tool calling.

### [​](https://platform.kimi.ai/docs/guide/kimi-k2-6-quickstart\#disable-thinking-capability-example)  Disable Thinking Capability Example
...
## [​](https://platform.kimi.ai/docs/guide/kimi-k2-6-quickstart\#model-pricing)  Model Pricing

For token pricing details, refer to [Model Pricing](https://platform.kimi.ai/docs/pricing/chat-k26).

## [​](https://platform.kimi.ai/docs/guide/kimi-k2-6-quickstart\#learn-more)  Learn More

- For the benchmark testing with Kimi K2.6, please refer to this [benchmark best practice](https://platform.kimi.ai/docs/guide/benchmark-best-practice)
- For the most detailed API usage example of Kimi K2.6, see: [How to Use Kimi Vision Model](https://platform.kimi.ai/docs/guide/use-kimi-vision-model)
- See [How to Use Kimi K2 in Claude Code, Roo Code, and Cline](https://platform.kimi.ai/docs/guide/agent-support)
- Learn how to configure and use the [Thinking Model](https://platform.kimi.ai/docs/guide/use-kimi-k2-thinking-model)
- Web search is a powerful official tool provided by the Kimi API. See how to use [Web Search](https://platform.kimi.ai/docs/guide/use-web-search) and other [official tools](https://platform.kimi.ai/docs/guide/use-official-tools).
- For all model pricing see [here](https://platform.kimi.ai/docs/pricing/chat), [Billing & Rate Limit details](https://platform.kimi.ai/docs/pricing/limits), and [Web Search Pricing](https://platform.kimi.ai/docs/pricing/tools)

Was this page helpful?

YesNo

[Kimi K2.7 Code Model](https://platform.kimi.ai/docs/guide/kimi-k2-7-code-quickstart) [Using Thinking Models](https://platform.kimi.ai/docs/guide/use-kimi-k2-thinking-model)

Ctrl+I

![kimi-k2.6](https://mintcdn.com/moonshotai/QKwipWA7W5wxQ2Oa/assets/pics/k26.png?w=1100&fit=max&auto=format&n=QKwipWA7W5wxQ2Oa&q=85&s=5ee6f1b77b0f0e8bd284e7a878e51308)